...
public class Libro implements Serializable {
    ...
    public String toString() {
        return "Libro= " + "ISBN: " + isbn + ", Titulo: " + titulo + ", Año: " + anio + ", Ejemplares: " + ejemplares + ", Ejemplares Prestados: " + ejemplaresPrestados + ", Ejemplares Restantes: " + ejemplaresRestantes + ", Alta: " + alta
                + ".\n Autor: " + autor
                + ".\n Editorial: " + editorial;
    }
